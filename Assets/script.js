...
// Need password to have ability to use all number characters
...
const specialCharacters = ["`", "~", "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "-", "_", "=", "+", ";", ":", "'", ",", "<", ".", ">", "?"] // Created constant for all Special Characters. May need to remove some.
...
function generatePassword() {
  ...
  if (passLength < 8 || passLength >149) {
    passAlert = alert("Password must be between 8 and 149 characters")
  } else {
